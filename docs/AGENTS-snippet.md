...
This project uses [Stello](https://stello-web-rho.vercel.app) so people without a crypto wallet can pay into our
Soroban contract with an ordinary bank transfer.

**Read https://stello-web-rho.vercel.app/llms-full.txt before changing payment code.**
